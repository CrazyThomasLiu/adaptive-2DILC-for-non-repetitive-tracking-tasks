...
for batch in range(batch_num):
    ...
    y_ref = y_ref_standard*(1+0.2*np.sin(0.5*batch))
...
if save_figure==True:
    plt.savefig('mfilc_response_v2_final.pdf')
...
#ax1.set_title('10-iteration $x_{1}$')
if save_figure==True:
    plt.savefig('mfilc_control_signal_v2_final.pdf')
    #plt.savefig('mfoilc_response_PILC.jpg',dpi=700)
...
if save_csv == True:
    ...
    df_RMSE.to_csv('RMSE_mfilc_v2_final.csv')
